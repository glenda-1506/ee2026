...
module Top_Student (
  ...
  //                 btnU, btnD, btnL, btnR, btnC, oled_data_A, sA[3], sA[2], sA[1], sA[0]);
    TASK_B task_b (clk_6p25M, x_addr_left, y_addr_left, sw, !CURRENT_SCREEN[1], fb, selected_key, key_pressed, led[15], led[14], oled_data_B, keyboard_locked, buffer_out, last_selected_reg);   
